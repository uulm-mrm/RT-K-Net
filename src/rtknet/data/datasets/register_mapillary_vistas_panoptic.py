...
# https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/data/datasets/register_mapillary_vistas_panoptic.py  # noqa
# Categories are sorted stuff first for training and inference to enable fast post-processing
import json
import os
...
def get_metadata():
    ...
    for k in MAPILLARY_VISTAS_SEM_SEG_CATEGORIES:
        if k["isthing"] == 1:
