...
# https://github.com/facebookresearch/Mask2Former/blob/main/mask2former/data/datasets/register_mapillary_vistas.py  # noqa
import os
...
def register_all_mapillary_vistas(root):
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        MetadataCatalog.get(name).set(
            ...
            ignore_label=65,  # Mapillary Vistas sets ignore_label to 65
            **meta,
        )
